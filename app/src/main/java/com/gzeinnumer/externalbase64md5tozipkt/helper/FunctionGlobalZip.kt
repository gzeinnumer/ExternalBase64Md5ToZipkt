package com.gzeinnumer.externalbase64md5tozipkt.helper
...
object FunctionGlobalZip {
    ...
    private fun converToZip(base64: String): Boolean {
        ...
        val fileZip = File(FunctionGlobalDir.getStorageCard + FunctionGlobalDir.appFolder + FunctionGlobalDir.appFile)
    ...
    private fun compareMd5(md5OriginValue: String): Boolean {
        ...
        try {
            ...
            val md5Checksum: String = Md5Checksum.md5(fis)
